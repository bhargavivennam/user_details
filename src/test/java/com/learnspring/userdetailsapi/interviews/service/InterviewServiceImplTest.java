...
public class InterviewServiceImplTest {
    ...
    void shouldCreateInterviewDetails() {
        ...
        // Act
        InterviewInfo result = interviewServiceImpl.createInterviewInfoDetails(interviewDto);

        // Assert
        assertEquals(interviewDto.recruiterName(), result.getRecruiterName());
        assertEquals(interviewDto.consultantName(), result.getConsultantName());
