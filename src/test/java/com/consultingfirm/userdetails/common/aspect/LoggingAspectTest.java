...
//        when(mockJoinPoint.getSignature().getDeclaringTypeName()).thenReturn("controller.benchprofiles.com.consultingfirm.userdetails.BenchProfilesController");
...
//                eq("controller.benchprofiles.com.consultingfirm.userdetails.BenchProfilesController"),
...
////        when(mockProceedingJoinPoint.getSignature().getDeclaringTypeName()).thenReturn("controller.benchprofiles.com.consultingfirm.userdetails.BenchProfilesController");
