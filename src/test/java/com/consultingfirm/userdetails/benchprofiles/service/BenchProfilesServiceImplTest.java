...
class BenchProfilesServiceImplTest {
    ...
    private BenchProfiles benchProfiles;

    @BeforeEach
    void setUp() {
        benchProfiles = BenchProfilesInfoMock.shouldCreateBenchProfilesDetails();
        profile = BenchProfilesInfoMock.shouldCreateProfile();
        benchProfilesInfo = BenchProfilesInfoMock.shouldSetBenchProfilesInfo(benchProfiles);
    }
    ...
    void shouldCreateUserInfoDetails() {
        ...
        // Act
        BenchProfilesInfo result = benchProfilesServiceImpl.createUserInfoDetails(benchProfiles);

        // Assert
        assertEquals(benchProfiles.recruiterName(), result.getRecruiterName());
        assertEquals(benchProfiles.consultantName(), result.getConsultantName());
