...
public class InterviewController {
    ...
    public ResponseEntity<InterviewInfo> createInterviewInfo(@Valid @RequestBody Interview interview) {
        var newInterviewInfo = interviewService.createInterviewInfoDetails(interview);
